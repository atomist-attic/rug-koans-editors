...
The Step1SeeSolution editor populates a set of additional files that show how the solution to this step should look *without* overwriting your working files.
...
The Step2 editor creates the files that are the starting point for this step on the Rug Koans journey.
...
```
$ cd targetproject
$ rug edit atomist-rugs:rug-koans-editors:Step2SeeSolution
```

### Step2OverwriteWithSolution

The Step2OverwriteWithSolution editor overwrites your working files for this step with the solution.
...
```
$ cd targetproject
$ rug edit atomist-rugs:rug-koans-editors:Step2Step1OverwriteWithSolution
```
